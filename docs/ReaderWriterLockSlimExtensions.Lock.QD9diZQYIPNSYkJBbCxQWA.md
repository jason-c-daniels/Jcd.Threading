...
## ReaderWriterLockSlimExtensions.Lock(this ReaderWriterLockSlim, CancellationToken, ReaderWriterLockSlimIntent) Method
...
```csharp
public static System.IDisposable Lock(this System.Threading.ReaderWriterLockSlim rwls, System.Threading.CancellationToken token, Jcd.Threading.ReaderWriterLockSlimIntent intent=Jcd.Threading.ReaderWriterLockSlimIntent.Read);
```
#### Parameters

<a name='Jcd.Threading.ReaderWriterLockSlimExtensions.Lock(thisSystem.Threading.ReaderWriterLockSlim,System.Threading.CancellationToken,Jcd.Threading.ReaderWriterLockSlimIntent).rwls'></a>
...
<a name='Jcd.Threading.ReaderWriterLockSlimExtensions.Lock(thisSystem.Threading.ReaderWriterLockSlim,System.Threading.CancellationToken,Jcd.Threading.ReaderWriterLockSlimIntent).token'></a>
...
<a name='Jcd.Threading.ReaderWriterLockSlimExtensions.Lock(thisSystem.Threading.ReaderWriterLockSlim,System.Threading.CancellationToken,Jcd.Threading.ReaderWriterLockSlimIntent).intent'></a>
