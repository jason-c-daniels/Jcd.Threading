...
## BlockingTaskProcessor.EnqueueActionAsync(Action) Method
...
```csharp
public System.Threading.Tasks.Task EnqueueActionAsync(System.Action command);
```
#### Parameters

<a name='Jcd.Tasks.BlockingTaskProcessor.EnqueueActionAsync(System.Action).command'></a>
