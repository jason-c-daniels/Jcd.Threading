...
## SemaphoreSlimExtensions.UseAsync(this SemaphoreSlim, CancellationToken) Method
...
```csharp
public static System.Threading.Tasks.Task<System.IDisposable> UseAsync(this System.Threading.SemaphoreSlim sem, System.Threading.CancellationToken token);
```
#### Parameters

<a name='Jcd.Tasks.SemaphoreSlimExtensions.UseAsync(thisSystem.Threading.SemaphoreSlim,System.Threading.CancellationToken).sem'></a>
...
<a name='Jcd.Tasks.SemaphoreSlimExtensions.UseAsync(thisSystem.Threading.SemaphoreSlim,System.Threading.CancellationToken).token'></a>
