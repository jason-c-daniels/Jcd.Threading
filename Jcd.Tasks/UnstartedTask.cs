...
public static class UnstartedTask
{
    ...
    public static Task Create(Action action, CancellationToken? cancellationToken = null,
    ...
    public static Task Create(Func<Task> action, CancellationToken? cancellationToken = null,
                              TaskCreationOptions options = TaskCreationOptions.RunContinuationsAsynchronously)
    {
        var task = cancellationToken.HasValue
    ...
    public static Task<TResult> Create<TResult>(Func<TResult> function, CancellationToken? cancellationToken = null,
    ...
    /// <typeparam name="TResult">The type of the data returned.</typeparam>
    public static Task<TResult> Create<TResult>(Func<Task<TResult>> function,
