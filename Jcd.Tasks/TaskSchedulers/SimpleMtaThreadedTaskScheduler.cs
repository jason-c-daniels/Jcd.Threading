...
/// for details.
/// </summary>
public abstract class SimpleMtaThreadedTaskScheduler : SimpleThreadedTaskScheduler
{
   /// <summary>
   /// Creates an instance of the type.
   /// </summary>
   /// <param name="threadCount">The number of threads to use for executing <see cref="Tasks"/> instances. </param>
   protected SimpleMtaThreadedTaskScheduler(int threadCount) : base(threadCount, ApartmentState.MTA) { }
}