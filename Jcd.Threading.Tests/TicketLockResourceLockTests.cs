...
public class TicketLockResourceLockTests
{
   [Fact]
   public void Lock_Returns_A_Ticket_With_The_Expected_Id()
   {
      ...
      TicketLockResourceLock t, t2, t3;
      using (t = tl.Lock())
   ...
   public void CurrentCount_Returns_Expected_Value()
   {
      ...
      using var t2 = tl.GetResourceLock();
      using var t3 = tl.GetResourceLock();
   ...
   [Fact]
   public void MaxTicketCount_Is_Long_MaxValue() { Assert.Equal(long.MaxValue, TicketLock.MaxTicketCount); }
}