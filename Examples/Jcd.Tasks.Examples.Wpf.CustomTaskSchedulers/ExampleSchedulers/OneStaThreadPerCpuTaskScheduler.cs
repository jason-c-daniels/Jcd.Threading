...
/// for details.
/// </summary>
public class OneStaThreadPerCpuTaskScheduler : SimpleThreadedTaskScheduler
{
   /// <inheritdoc />
   public OneStaThreadPerCpuTaskScheduler() : base(Environment.ProcessorCount, ApartmentState.STA) { }
}